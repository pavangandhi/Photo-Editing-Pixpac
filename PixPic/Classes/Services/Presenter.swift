...
extension ProfilePresenter {
    ...
    func showMyProfileWithPost(postId: String) {
        ...
        if let currentViewController = currentViewController as? ProfileViewController where currentViewController.user == User.currentUser() {
            currentViewController.setUserInfo(postId)
        } else if let appearanceController = currentViewController.navigationController as? AppearanceNavigationController {
